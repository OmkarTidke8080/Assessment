...
function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      alert("SignUp failed. Please try again."); // Optional: show an alert on error
    }
  };
              ...
              <div>
                ...
                <div className="mt-3">
                  ...
                  <select
                    ...
                    name="role"
                    id="role"
                    style={{ backgroundColor: "inherit" }} // Ensure background inherits
                  >
                    <option className="text-white bg-inherit" value="">
                      Select Role
                    </option>
                    <option className="text-white bg-inherit" value="manager">
                      manager
                    </option>
                    <option className="text-white bg-inherit" value="user">
                      user
                    </option>
                  </select>
                </div>
