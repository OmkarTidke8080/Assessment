            ...
            <div className=" buttons-part w-1/2 border-white border-2 rounded-3xl h-[450px]">
              <div className="flex justify-center items-center h-[450px]">
                <div>
                  <div className="mb-16">
                    <input type="checkbox" />
                    <button className="text-white  font-">Request Otp</button>
                  </div>

                  <div className="mb-16">
                    <input type="checkbox" />
                    <button className="text-white font-">Verify Otp</button>
                  </div>

                  <div>
                    <input type="checkbox" />
                    <button className="text-white font-">Reset Password</button>
                  </div>
                </div>
              </div>
            </div>
