            ...
            <div className=" buttons-part w-1/2 border-white border-2 rounded-3xl h-[450px]">
              <div className="flex justify-center items-center h-[450px]">
                <div>
                  <div className="mb-16">
                    <input type="checkbox" />
                    <button className="text-white  font-l">Request Otp</button>
                  </div>

                  <div className="mb-16">
                    <input type="checkbox" />
                    <button className="text-white font-l">Verify Otp</button>
                  </div>

                  <div>
                    <input type="checkbox" />
                    <button className="text-white font-l">Reset Password</button>
                  </div>
                </div>
              </div>
            </div>
