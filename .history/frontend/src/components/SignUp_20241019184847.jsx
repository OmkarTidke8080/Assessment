  ...
  return (
    <>
      <div className="flex justify-center items-center mt-5">
        <div className="flex border  rounded-md h-[600px] w-[700px]">
          <div className="form border-2 rounded-3xl text-white w-full bg-gradient-to-r from-gray-900 to-slate-600 ">
            <div className="form-heading font-medium font-serif mt-8">
              <h1>Sign Up Form</h1>
            </div>
            ...
            <form>
              <div className="flex justify-center mt-10 ">
                <div>
                  ...
                  <div className="sign-up-button m-16">
                    <button className="border-2 rounded p-2 w-24 ">
                      Sign Up
                    </button>
                  </div>
