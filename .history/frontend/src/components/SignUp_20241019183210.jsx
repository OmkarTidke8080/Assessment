              ...
              <div className="flex justify-center mt-5 ">
                <div>
                  ...
                  <div className="flex w-full">
                    <div className="mt-3">
                      <label htmlFor="AdharCard" className=" flex mb-1">
                        Aadhaar Card
                      </label>
                      <input
                        type="file"
                        id="FistName"
                        className="text-white w-1/2 flex border rounded p-2"
                        required
                      />
                    </div>
                    <div className="mt-3">
                      <label htmlFor="PanCard" className=" flex mb-1">
                        Pan Card
                      </label>
                      <input
                        type="file"
                  ...
                  <div className="sign-up-button m-5">
