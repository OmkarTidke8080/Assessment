              ...
              <div className="flex justify-center items-center h-[450px]">
                <div>
                  ...
                  <div className="flex items-center mb-6">
                    <input
                      type="checkbox"
                      checked={activeForm === "verifyOtp"}
                      onChange={() =>
                        setVerifyOtpIsChecked(!verifyOtpIsChecked)
                      }
                      className="form-checkbox text-green-500 rounded "
                    />
                    <button className="text-white font-semibold ml-2 px-4 py-2 border border-green-500 rounded">
                  ...
                  <div className="flex items-center mb-6">
                    <input
                      type="checkbox"
                      checked={activeForm === "resetPassword"}
                      onChange={() =>
                        setResetPasswordIsChecked(!resetPasswordIsChecked)
                      }
                      className="form-checkbox text-green-500 rounded "
                    />
                    <button className="text-white font-semibold ml-2 px-4 py-2 border border-green-500 rounded">
